                    ...
                    <div class="w-full md:w-3/12 md:mx-2">
                        ...
                        <div class="bg-white p-3 border-t-4 border-green-400">
                            <div class="relative image overflow-hidden">
                                ...
                                <form action="{{ route('edit_profile') }}" enctype="multipart/form-data">
                                    <div class="absolute right-0 bottom-0 z-0 w-full mb-5 group">
                                        <input value="{{ $user->medecin->image }}" type="file" id="avatar" name="image"/>
                                    </div>
                                </form>
                    ...
                    <div class="w-full md:w-9/12 mx-2 h-64">
                        ...
                        <div class="bg-white p-3 shadow-sm rounded-sm">
                            ...
                            <div class="text-gray-700">
                                <div class="relative grid md:grid-cols-2 text-sm">
                                    <button class="absolute right-0">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                            viewBox="0 0 24 24">
                                            <path fill="currentColor" fill-opacity="0" d="M20 7L17 4L8 13V16H11L20 7Z">
                                    ...
                                    <div class="grid grid-cols-2">
                                        ...
                                        <div class="px-4 py-2">{{ $user->numero }}</div>
                                    </div>
                                    <div class="grid grid-cols-2">
                                    ...
                                    <div class="mt-10">
                                        ...
                                        {{-- <div > --}}
                                        <div class="grid grid-cols-2">
                                            <div class="px-4 py-2 font-semibold">Nom du cabinet</div>
                                            <div class="px-4 py-2">{{ $user->medecin->specialite->specialite }}</div>
                                        </div>

                                        <div class="grid grid-cols-2">
                                            <div class="px-4 py-2 font-semibold">Nom du cabinet</div>
                                            <div class="px-4 py-2">{{ $user->medecin->cabinet }}</div>
                                        </div>

                                        <div class="grid grid-cols-2">
                                            <div class="px-4 py-2 font-semibold">Adresse</div>
                                            <div class="px-4 py-2">{{ $user->ville->nom }},
                                                {{ $user->medecin->adresse_cabinet }}</div>
                                        </div>
                                        {{-- </div> --}}
                                    </div>
                                </div>
